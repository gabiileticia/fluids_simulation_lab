...
int main()
{
    ...
    int count_del;
    double particle_radius, dt_cfl, dt, dt_default, t_next_frame, t_between_frames, t_simulation, B,
        v_f, v_b, fluid_particle_mass;
    ...
    while (t_simulation < 5) {
        ...
        std::cout << "v_max " << semImpEuler.v_max << "\n";
        // compute dt
        ...
        acceleration.accelerations(particles_accelerations, particles_densities, particles_pressure,
                                   ...
                                   fluid_rest_density, fluid_particle_mass);
