...
void learnSPH::simulations_setup::Simulations::drop_of_water(){
    this->particle_radius = 0.005;
    this->fluid_rest_density = 1000.0;
    ...
    this->fluid_begin[0] = Eigen::Vector3d(0.0, 0.0, 0.0);
    this->fluid_end[0] = Eigen::Vector3d(0.98, 0.98, 0.98);
    this->fluid_velocities[0] = Eigen::Vector3d(0.0, 0.0, 0.0);
    ...
    this->v_b = 0.0;
    this->gravity = Eigen::Vector3d(0.0, 0.0, -9.81);
    this->assignment = "assignment5/drop_of_water";

    this->emitters.resize(1);
    this->emitters[0].dir = {0,0,-1};
    this->emitters[0].origin = {.5,.5,.5};
    this->emitters[0].r = 0.03;
    this->emitters[0].velocity = 0.5;
    this->emitters[0].alternating = false;
    this->emitters[0].emission_freq = 0.1;
    this->emitters[0].emit_counter = 1;    
